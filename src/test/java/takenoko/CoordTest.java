...
public class CoordTest {
    ...
    void adjacentCoordsTest() {
        ...
        assertEquals(new Coord(1, 1), adjacentCoords[0]);
        assertEquals(new Coord(2, 1), adjacentCoords[1]);
        assertEquals(new Coord(2, 2), adjacentCoords[2]);
        assertEquals(new Coord(1, 3), adjacentCoords[3]);
        assertEquals(new Coord(0, 3), adjacentCoords[4]);
        assertEquals(new Coord(0, 2), adjacentCoords[5]);
    }
